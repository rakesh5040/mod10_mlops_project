...
categorical_features = ["TypeofContact","Occupation","MaritalStatus","Designation","ProductPitched"]
...
with mlflow.start_run():
    ...
    model_path = "tourism_project/deployment/best_visit_with_us_pred_purch_model_v1.joblib"
